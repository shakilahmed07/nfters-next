    ...
    <div className="grid grid-cols-2 gap-8 w-10/12 mx-auto h-[600px]">
      <div className="flex items-center justify-center relative">
        <div className="mr-10 relative">
          ...
          {/* avatar - 1 */}
          <div className="absolute top-[48%] right-[-20px]">
            <Image src={AvatarTwo} alt="" height={"50px"} width={"50px"} />
          </div>
          {/* avatar - 2 */}
          <div className="absolute top-[92%] right-[-20px]">
            <Image src={AvatarTwo} alt="" height={"50px"} width={"50px"} />
          </div>
        </div>
        <div>
        ...
        {/* avatar - 3 */}
        <div className="absolute top-[60%] right-[40px]">
      ...
      <div className="space-y-6 flex flex-col  justify-center">
        ...
        <button
          type="submit"
          className="bg-[rgb(61,0,183)] hover:bg-[rgba(61,0,183,0.88)] text-white rounded-3xl text-sm py-3 font-semibold w-3/12"
        >
          Sign Up Now
        </button>
      </div>
