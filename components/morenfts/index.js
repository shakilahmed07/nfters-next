      ...
      <div className='w-10/12 mx-auto py-10 space-y-4'>
        ...
        <div className='sm:flex items-center justify-between text-sm hidden'>
          <div className='flex items-center justify-center space-x-4'>
            <p className='bg-[rgb(61,0,183)] hover:bg-[rgba(61,0,183,0.88)] rounded-full px-4 py-[6px] text-white'>All Categories</p>
        ...
        <NftsCards />
        <NftsCards />
        <h2 className='text-center text-[#371C87] border-2 rounded-full w-[150px] py-2 mx-auto border-[#371C87] font-semibold'>MORE NFTS</h2>
      </div>
    </div>
  )
}
