...
const Header = () => {
  return (
    <div className="h-[70px] sticky top-0 bg-white z-10 flex items-center justify-center border-b-2 border-gray-100">
      <div className="flex items-center justify-between w-10/12 mx-auto ">
      <Image src={NFters} alt="" />
      <div>
        <ul className="flex space-x-8">
          <li className="text-sm font-semibold">Marketplace</li>
          <li className="text-sm font-semibold">Resource</li>
